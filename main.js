...
const settingsHandlers = require('./modules/ipc/settingsHandlers.js'); // Import settings IPC handlers
...
const chatHandlers = require('./modules/ipc/chatHandlers.js'); // Import chat handlers
const groupChatHandlers = require('./modules/ipc/groupChatHandlers'); // Import group chat handlers
const sovitsHandlers = require('./modules/ipc/sovitsHandlers.js'); // Import SovitsTTS IPC handlers
